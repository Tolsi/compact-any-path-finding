 ...
 */
public class AAPFIndirectHeap<E extends Comparable<? super E>> implements Serializable {
    ...
    public AAPFIndirectHeap(boolean minHeap) {
     ...
     * Runtime: O(n)
     */
    public AAPFIndirectHeap(E[] array, boolean minHeap) {
        this(minHeap);
