...
public class AAPFBreadthFirstSearch extends AAPFAStar {

    private Queue<Integer> queue;
    
    public AAPFBreadthFirstSearch(AAPFGridGraph graph, int sx, int sy, int ex, int ey) {
        super(graph, sx, sy, ex, ey);
        postSmoothingOn = false;
    }

    public static AAPFBreadthFirstSearch postSmooth(AAPFGridGraph graph, int sx, int sy, int ex, int ey) {
        AAPFBreadthFirstSearch bfs = new AAPFBreadthFirstSearch(graph, sx, sy, ex, ey);
