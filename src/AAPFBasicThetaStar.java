public class AAPFBasicThetaStar extends AAPFAStarStaticMemory {
    
    public AAPFBasicThetaStar(AAPFGridGraph graph, int sx, int sy, int ex, int ey) {
        super(graph, sx, sy, ex, ey);
    }
    
    public static AAPFBasicThetaStar postSmooth(AAPFGridGraph graph, int sx, int sy, int ex, int ey) {
        AAPFBasicThetaStar bts = new AAPFBasicThetaStar(graph, sx, sy, ex, ey);
        bts.postSmoothingOn = true;
        return bts;
    }
    
    public static AAPFBasicThetaStar noHeuristic(AAPFGridGraph graph, int sx, int sy, int ex, int ey) {
        AAPFBasicThetaStar bts = new AAPFBasicThetaStar(graph, sx, sy, ex, ey);
