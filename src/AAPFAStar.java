public class AAPFAStar extends AAPFPathFindingAlgorithm {
    ...
    protected AAPFIndirectHeap<Float> pq;

    protected int finish;

    
    public AAPFAStar(AAPFGridGraph graph, int sx, int sy, int ex, int ey) {
        super(graph, graph.sizeX, graph.sizeY, sx, sy, ex, ey);
    }

    public static AAPFAStar postSmooth(AAPFGridGraph graph, int sx, int sy, int ex, int ey) {
        AAPFAStar aStar = new AAPFAStar(graph, sx, sy, ex, ey);
        aStar.postSmoothingOn = true;
        return aStar;
    }

    public static AAPFAStar dijkstra(AAPFGridGraph graph, int sx, int sy, int ex, int ey) {
        AAPFAStar aStar = new AAPFAStar(graph, sx, sy, ex, ey);
    ...
    public void computePath() {
        ...
        pq = new AAPFIndirectHeap<Float>(distance, true);
        pq.heapify();
